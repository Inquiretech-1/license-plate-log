...
A simple, browser-based app (`license-plate-log.html`) for **recording license plates** you associate with **unsafe driving**—for example behavior that seems **reckless** or that **endangered** another driver, cyclist, or pedestrian.
